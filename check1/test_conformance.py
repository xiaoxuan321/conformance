...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if param == "BPIC13_cp":
            ...
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC13_cp, net_inductive,
            ...
            net_inductive, im_inductive, fm_inductive = pm4py.discover_petri_net_inductive(BPIC13_i,
                                                                                                 ...
                                                                                                 case_id_key='case:concept:name',
                                                                                                 timestamp_key='time:timestamp')
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC13_i, net_inductive,
                                                                                         im_inductive, fm_inductive,
                                                                                         activity_key='concept:name',
                                                                                         case_id_key='case:concept:name',
                                                                                         timestamp_key='time:timestamp')
            ...
            net_inductive, im_inductive, fm_inductive = pm4py.discover_petri_net_inductive(BPIC15_1f,
                                                                                                 ...
                                                                                                 case_id_key='case:concept:name',
                                                                                                 timestamp_key='time:timestamp')
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC15_1f, net_inductive,
                                                                                         im_inductive, fm_inductive,
                                                                                         activity_key='concept:name',
                                                                                         case_id_key='case:concept:name',
                                                                                         timestamp_key='time:timestamp')
            ...
            net_inductive, im_inductive, fm_inductive = pm4py.discover_petri_net_inductive(BPIC15_2f,
                                                                                                 ...
                                                                                                 case_id_key='case:concept:name',
                                                                                                 timestamp_key='time:timestamp')
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC15_2f, net_inductive,
                                                                                         im_inductive, fm_inductive,
                                                                                         activity_key='concept:name',
                                                                                         case_id_key='case:concept:name',
                                                                                         timestamp_key='time:timestamp')
            ...
            net_inductive, im_inductive, fm_inductive = pm4py.discover_petri_net_inductive(BPIC15_4f,
                                                                                                 ...
                                                                                                 case_id_key='case:concept:name',
                                                                                                 timestamp_key='time:timestamp')
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC15_4f, net_inductive,
                                                                                         im_inductive, fm_inductive,
                                                                                         activity_key='concept:name',
                                                                                         case_id_key='case:concept:name',
                                                                                         timestamp_key='time:timestamp')
            ...
            net_inductive, im_inductive, fm_inductive = pm4py.discover_petri_net_inductive(BPIC15_5f,
                                                                                                 ...
                                                                                                 case_id_key='case:concept:name',
                                                                                                 timestamp_key='time:timestamp')
            tbr_diagnostics_inductive = pm4py.conformance_diagnostics_token_based_replay(BPIC15_5f, net_inductive,
                                                                                         im_inductive, fm_inductive,
                                                                                         activity_key='concept:name',
                                                                                         case_id_key='case:concept:name',
                                                                                         timestamp_key='time:timestamp')
